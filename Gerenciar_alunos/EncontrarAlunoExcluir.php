    ...
    if ($idAlvo === '') {
        ...
        if ($arqAlunos) {
            ...
            if (count($resultados) == 0) {
                ...
                header("Location: ExcluirAluno.php?matricula=" . $resultados[0]['matricula']);
                exit;
            }
        } else {
...
<body>
    ...
    <form method="POST" action="EncontrarAlunoExcluir.php">
    ...
    <p><a href="InserirAlunos.php">Voltar para cadastro</a> | <a href="ListarAlunos.php">Listar todos os alunos</a></p>
</body>
</html>